...
library(ggplot2)
ggplot(NHANES_12, aes(HealthGen, Poverty, fill=Gender)) + 
  geom_boxplot() +
  theme_gray() +
...
plot(NHANES_12$Race1, NHANES_12$HealthGen)

ggplot(NHANES_12, aes(Gender, Poverty, fill=Gender)) + 
  geom_boxplot() +
  theme_gray() +
  scale_fill_brewer(palette="Set1") +
  stat_summary(fun = median, geom = "line", aes(group=Gender, color=Race1))

ggplot(NHANES_12, aes(Gender, Poverty, fill=Race1)) + 
  geom_boxplot() +
  theme_gray() +
  scale_fill_brewer(palette="YlOrBr") +
  stat_summary(fun = median, geom = "line", aes(group=Gender, color=Race1))
...
ggplot(NHANES_12, aes(Race1, Poverty, fill=Gender)) + 
  geom_boxplot() +
  theme_gray() +
  scale_fill_brewer(palette="YlOrBr") +
  stat_summary(fun = median, geom = "line", aes(group=Gender, color=Race1))
...
ggplot(NHANES_12, aes(Gender, Poverty, fill=MaritalStatus)) + 
  geom_boxplot() +
  theme_gray() +
  scale_fill_brewer(palette="YlOrBr") +
  stat_summary(fun = median, geom = "line", aes(group=Gender, color=Race1))
...
ggplot(NHANES_12, aes(sample=Poverty))+
  geom_qq() +
  geom_qq_line() + 
  facet_grid(~Gender)
...
byf.shapiro(Poverty ~ Gender, NHANES_12)
leveneTest(Poverty ~ Gender, NHANES_12)#, center=mean)

t.test(Poverty ~ Gender, NHANES_12, var.equal=TRUE)
...
NHANES_12$HHIncomeMid_log <- log(NHANES_12$HHIncomeMid + 1)
...
ggplot(NHANES_12, aes(HealthGen, HHIncomeMid_log, fill=Gender)) + 
  geom_boxplot() +
  theme_gray() +
  scale_fill_brewer(palette="YlOrBr") +
  stat_summary(fun = median, geom = "line", aes(group=Gender, color=Gender))

modelo2 <- lm(HHIncomeMid_log ~ HealthGen * Gender, data = NHANES_12)
